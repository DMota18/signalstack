    ...
    <div className="min-h-screen flex items-center justify-center px-4"
      ...
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              style={{ background: surface, border: `0.5px solid ${border}`, color: isDark ? '#E8E6E1' : '#1A1A1D' }}
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              style={{ background: surface, border: `0.5px solid ${border}`, color: isDark ? '#E8E6E1' : '#1A1A1D' }}
            />
            <p className="text-[11px] mt-1 font-body" style={{ color: isDark ? '#3A3A3D' : '#AAACB0' }}>
        ...
        <p className="text-center text-sm font-body mt-6" style={{ color: textMuted }}>
          ...
          <Link to="/signin" style={{ color: gold }}>Sign in</Link>
        </p>
      </div>
    </div>
  );
